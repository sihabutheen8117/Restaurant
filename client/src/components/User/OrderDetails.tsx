    ...
    <div className='h-full'>
        ...
        <div className='mx-5 h-9/12 overflow-y-auto border-t-2 border-b-2 border-gray-300'>
            ...
            get_ordered_food_query.data.data.map( (item:any , index : any  ) => (
                ...
                <div className=''>
                <div className='flex gap-2 h-16 bg-gray-300' >
                    <img src={item.food_image} alt={item.food_name} className='object-cover w-16 h-16 rounded-lg mx-auto'/>
        ...
        <div className='flex justify-between mx-5 my-3'>
            ...
            <button className='bg-green-400 text-white hover:bg-green-500 rounded-xl px-3'
            onClick={ () => props.close() }
            >
                Close
            </button>
